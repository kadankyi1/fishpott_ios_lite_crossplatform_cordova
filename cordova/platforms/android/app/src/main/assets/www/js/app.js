...
function urlify(text) {
    ...
    return text.replace(urlRegex, function(url) {
        return "<a class='link external' style=' word-break; break-all; color: black; font-weight : bolder;' target='_blank' href='" + url + "'>" + url + "</a>";
    })
    // or alternatively
