...
function setNews(total_news_num, newsResponse, newsholderid){
                ...
                for (var i = 0; i < total_news_num; i++) {
                    ...
                    if(newsResponse["hits"][i]["news_id"] != "") {
                        ...
                        news_main = escapeHtml(news_main);
                        ...
                        */
                        ...
                        if(news_set_like_color == 1){
                            ...
                            like_icon_type_android = "favorite_border_fill";
  ...
  if( news_set_url_card != 1 && news_image_display_style == "none" && 
      news_shared_image_display_style == "none" && news_video_display_style == "none"){
...
//<i class="fa fa-heart fa-stack-1x "></i><i class="fa fa-bolt fa-stack-1x fa-inverse"></i>
                        if(news_type == "news"){
                            ...
                            $('#'+newsholderid).append($('<div class="card demo-facebook-card" style="margin-right: 0; margin-left: 0;"><div class="card-header"><a href="#" class="link popover-open" onclick="setGlobalNewsId(this);" data-newsid = "'+ news_id +'" data-popover=".popover-menu" style="float: right;"><i class="icon f7-icons ios-only" style="font-size: 20px;">more_vertical</i></a><div onclick="getPottInfo(this);" data-pottname = "'+ news_maker_pottname +'" class="demo-facebook-avatar popup-open" data-popup=".pott" style="background-image: url(' + news_maker_pro_pic + '); background-size: cover; position: relative; width: 60px; padding-top: 60px; border-radius: 50%; margin-right: 5px"></div><div class="demo-facebook-name" style="font-weight : bolder;">' + news_maker_full_name + '&nbsp;<i class="icon f7-icons ios-only" style="font-size: 13px; color : #3399ff;display: ' + news_maker_verified_status_display_style + '">check_round_fill</i></div><div class="demo-facebook-date" style="font-style:italic; color:green;">@' + news_maker_pottname + '</div><div class="demo-facebook-date">' + news_date + '</div></div><div class="card-content"><p style="margin-left: 10px; font-size: ' + news_text_font_size +';" onclick="copyNewsText(this);" data-newstext="' + news_main_real + '" >' + news_main + '</p><a  target="_blank" data-url="url_holder" href = "' + news_url_web_address + '"><div style="display: ' + news_card_display_style + '" class="card elevation-4"><a  target="_blank" href="' + news_url_web_address + '"><div style="position: relative; width: 100%; padding-top: 100%;"><div style="width: 100%; height: 50%; margin-top: -100%"><img id="news_url_img_' + news_id + '" src="' + news_url_image + '" width="100%;"></div><div style="width: 100%; height: 50%; background-color: white;"><a target="_blank" href="' + news_url_web_address + '"><p style="overflow: hidden; text-overflow: hidden; -webkit-line-clamp:2; -webkit-box-orient: vertical; display: -webkit-box; font-weight: 900; margin: 16px 5px;">' + news_url_title + '</p></a><a target="_blank" href="' + news_url_web_address + '"><p style="overflow: hidden; text-overflow: hidden; -webkit-line-clamp:1; -webkit-box-orient: vertical; display: -webkit-box; margin: 16px 5px;">' + news_url_web_address + '</p></a></div></div></a></div></a><a href="#" @click="openStandalone"><div style="background-image: url(' + news_image + '); background-size: cover; position: relative; width: 100%; padding-top: 100%;  display: '+ news_image_display_style +'"></div></a><video ' + poster_code + '  onclick="playPauseThisVideo(this)" onplay="pauseOtherPlayers(this)" onpause = "pauseVideo(this)" id="video_' + news_id + '" data-newsid = "'+ news_id +'" style="width: 100%; display: '+ news_video_display_style +'" height="500px;"  controls preload="auto"><source src="' + news_video + '" type="video/mp4"><source src="' + news_video + '" type="video/webm"></video></div><p class="likes" style="font-size: 10px; line-height: 0.8;"><span style="display: ' + likes_display_style + '" onclick="getLikes(this);" data-type="1" data-newsid = "'+ news_id +'" class="popup-open" data-popup=".popup-likes">Likes: ' + news_likes_num + ' </span>&nbsp;<span style="display: ' + dislikes_display_style + '" data-type="2" onclick="getLikes(this);" data-newsid = "'+ news_id +'" class="popup-open" data-popup=".popup-likes">dislikes:  ' + news_dislikes_num + '  </span>&nbsp;<span style="display: ' + comment_display_style + '" onclick="getComments(this);" data-newsid = "'+ news_id +'" class="popup-open" data-popup=".comments">Comments:  ' + news_comment_num + '  </span>&nbsp;<span style="display: ' + repost_display_style + '">reposts:  ' + news_share_num + ' </span>&nbsp;<span style="display: ' + news_views_num_display_style + '">views:  ' + news_views_num + ' </span></p><div class="card-footer"><a onclick="likeThis(this);" data-liketype="1" data-newsid = "'+ news_id +'" id="like_'+ news_id +'" data-status = "' + news_set_like_color + '" href="#" class="link"> <i  id="android_like_icon_' + news_id + '" class="icon material-icons md-only" style="font-size: 20px; color : '+ news_like_color + '">' + like_icon_type_android + '</i><i id="ios_like_icon_' + news_id + '" class="icon f7-icons ios-only" style="font-size: 20px; color : '+ news_like_color + '">' + like_icon_type + '</i></a><a onclick="likeThis(this);" data-liketype="2"  data-newsid = "'+ news_id +'" id="dislike_'+ news_id +'" data-status = "' + news_set_dislike_color + '" href="#" class="link"><img src="img/'+ dislike_icon_type + '" width="24px" height="24px" id="ios_dislike_icon_' + news_id + '"></a><a href="#" onclick="getComments(this);" data-newsid = "'+ news_id +'" class="link popup-open" data-popup=".comments"><i class="icon material-icons md-only" style="font-size: 20px;">chat_bubble_outline</i><i class="icon f7-icons ios-only" style="font-size: 20px;">chat</i></a><a href="#" onclick="setGlobalNewsId(this);" data-newsid = "'+ news_id +'" class="link popover-open" data-popover=".popover-repost"><i class="icon material-icons md-only" style="font-size: 20px;">cached</i><i class="icon f7-icons ios-only" style="font-size: 20px;">reply</i></a></div></div>'));
                            ...
                            $('#'+newsholderid).append($('<div class="card demo-facebook-card" style="margin-right: 0; margin-left: 0;"><div class="card-header"><a href="/messages/" data-receivername = "' + news_maker_full_name + '"  data-receiverpic="' + news_maker_pro_pic + '" onclick="startChat(this)" data-tablename = "' + this_chat_table + '"  data-receiverpottname = "' + news_maker_pottname + '"  class="link popup-close" style="float: right;"><i class="icon f7-icons ios-only" style="font-size: 20px;">chats</i></a><div class="demo-facebook-avatar" style="background-image: url(' + news_maker_pro_pic + '); background-size: cover; position: relative; width: 60px; padding-top: 60px; border-radius: 50%; margin-right: 5px;"></div><div class="demo-facebook-name">' + news_maker_full_name + '</div><div class="demo-facebook-date">@' + this_chat_table + '</div><div class="demo-facebook-date"><span>' + news_sub + ' pearls</span></div><div class="demo-facebook-date"><span>' + news_date + '</span></div></div></div>'));
...
function urlify(text) {
    ...
    return text.replace(urlRegex, function(url) {
        return "<a style='color: black; font-weight : bolder;' target='_blank' href='" + url + "'>" + url + "</a>";
    })
    // or alternatively
...
function postJustNews(){
      ...
      if(post_img.trim() == ""  && post_vid.trim() == ""  && post_text.trim() == "" ){
    ...
    if(thisType == "1"){
      ...
      if(likeStatus != "" && dislikeStatus != ""){
          ...
          if(likeStatus == 1){
            ...
            android_like_icon.innerHTML = "favorite_border_fill";
            android_like_icon.style.color = "#ff6300";
...
document.getElementById("transaction_cart_info_totalcharge_cedis_main").innerHTML = "Ghc " + newsResponse["hits"][0]["total_charge_num_cedis"];
          ...
          fixSaleForm('cart', '2', '');
              ...
              showToast("Something went awry. Restart app and try again 1");
              ...
              showToast("Something went awry. Restart app and try again 2");
                            ...
                            if(total_news_num <= 0){
                                ...
                                for (var i = total_news_num-1; i >= 0; i--) {
                                        ...
                                        if(item_quantity > 0 || item_sale_status.trim() != "0"){
                                            ...
                                            $('#cart_results_holder').append($('<div class="card demo-facebook-card" style="margin-right: 0; margin-left: 0;"><div class="card-header"><div class="demo-facebook-avatar" style="background-image: url(' + item_image + '); background-size: cover; position: relative; width: 60px; padding-top: 60px; border-radius: 50%; margin-right: 5px;"></div><div class="demo-facebook-name">' + item_name + '</div><div class="demo-facebook-date">' + item_price + ' per item</div><div class="demo-facebook-date">Availble Quantity : ' + item_quantity + '</div></div><div class="list no-hairlines-md"><ul><li class="item-content item-input"><div class="item-inner"><div class="item-title item-label">How many do you want to buy (Maximum : ' + item_quantity + ')</div><div class="item-input-wrap"><input id="' + cart_item_id + '" data-maxquantity = "' + item_quantity + '"  data-newsid = "' + item_news_id + '" type="number" min="1" placeholder="Enter Quantity"><span class="input-clear-button"></span></div></div></li></ul></div></div>'));
                                        }
...
function postComment(x){
    ...
    var news_maker_verified_status = my_verified_tag;
      ...
      $('#comments_holder').append($('<div class="message message-received"><div class="message-avatar" style="background-image:url(' + news_maker_pro_pic + '); opacity: 1;"></div><div class="message-content"><div class="message-name" style="display: block;">'+ news_maker_full_name +' | @'+ news_maker_pottname +' <i class="icon f7-icons ios-only" style="font-size: 13px; color : #3399ff;display: ' + news_maker_verified_status_display_style + '">check_round_fill</i></div><div class="message-bubble"><div class="message-text">' + news_type + '<br><span style="float: right; font-size: 10px;">'+ news_date +' </span></div></div></div></div><br>'));
                ...
                for (var i = news_show_toggle; i  < total_news_num; i++) {
                        ...
                        if(i == 0){
                            ...
                            if(news_type == "1"){
                                ...
                                $('#'+holder_id).append($('<div class="card demo-facebook-card" style="margin-right: 0; margin-left: 0;"><div class="card-header"><a href="#" class="link" style="float: right;"><i class="icon f7-icons ios-only" style="font-size: 20px;color: #ff6300">heart_fill</i></a><div class="demo-facebook-avatar popup-open" data-popup=".pott" data-pottname = "'+ news_maker_pottname +'"  onclick="getPottInfo(this);"  style="background-image: url(' + news_maker_pro_pic + '); background-size: cover; position: relative; width: 60px; padding-top: 60px; border-radius: 50%; margin-right : 5px;"></div><div class="demo-facebook-name popup-open" data-popup=".pott" data-pottname = "'+ news_maker_pottname +'"  onclick="getPottInfo(this);" >' + news_maker_full_name + '</div><div class="demo-facebook-date">@' + news_maker_pottname + '</div><div class="demo-facebook-date">' + news_date + '</div></div></div>'));
                                ...
                                $('#'+holder_id).append($('<div class="message message-received"><div class="message-avatar popup-open" data-popup=".pott" data-pottname = "'+ news_maker_pottname +'"  onclick="getPottInfo(this);"  style="background-image:url(' + news_maker_pro_pic + '); opacity: 1;"></div><div class="message-content"><div class="message-name popup-open" data-popup=".pott" data-pottname = "'+ news_maker_pottname +'"  onclick="getPottInfo(this);" style="display: block;">'+ news_maker_full_name +' | @'+ news_maker_pottname +' <i class="icon f7-icons ios-only" style="font-size: 13px; color : #3399ff;display: ' + news_maker_verified_status_display_style + '">check_round_fill</i></div><div class="message-bubble"><div class="message-text">' + news_type + '<br><span style="float: right; font-size: 10px;">'+ news_date +' </span></div></div></div></div><br>'));
          ...
          success: function(response){
            ...
            if(total_bios_data > 0 && biosResponse["pott_info"][0]["full_name"] != "" && 
                ...
                if(this_pottname == '???'){
                  ...
                  document.getElementById("pott_linkupsnum_mine_main").innerHTML =  this_linked ;
                  document.getElementById("pott_linkednum_mine_main").innerHTML = this_linkups  ;
                  ...
                  document.getElementById("pott_linkupsnum_other_main").innerHTML =  this_linked ;
                  document.getElementById("pott_linkednum_other_main").innerHTML = this_linkups  ;
        ...
        console.log("total_news_num : " + total_news_num);
            ...
            document.getElementById("links_results_holder").innerHTML = "";
                ...
                for (var i = 0; i  < total_news_num; i++) {
                        ...
                        $('#links_results_holder').append($('<div class="card demo-facebook-card" style="margin-right: 0; margin-left: 0;"><div class="card-header"><a href="/messages/" data-receivername = "' + full_name + '"  data-receiverpic="' + profile_pic + '" onclick="startChat(this)" data-tablename = "' + this_chat_table + '"  data-receiverpottname = "' + pott_name + '"  class="link popup-close" style="float: right;"><i class="icon f7-icons ios-only" style="font-size: 20px;">chats</i></a><div class="demo-facebook-avatar" style="background-image: url(' + profile_pic + '); background-size: cover; position: relative; width: 60px; padding-top: 60px; border-radius: 50%; margin-right: 5px;"></div><div class="demo-facebook-name">' + full_name + '</div><div class="demo-facebook-date">@' + pott_name + '</div><div class="demo-facebook-date"><span>' + net_worth + ' pearls</span>  <span style="float: right;">' + investor_level + '</span></div><div class="demo-facebook-date"><span>' + country + '</span>  <span style="float: right;"> last online : ' + last_online_formatted + '</span></div></div></div>'));
...
allPopUpsArray = document.querySelectorAll('.popup-close');
...
postNewsBtnsArray.forEach(function(btn) {
    btn.addEventListener("click", function(e) {
        ...
        /*
          currentCroppedImage = cropper.getCroppedCanvas({
